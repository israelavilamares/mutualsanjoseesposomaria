...
namespace mutualsanjoseesposomaria
{
    public partial class pagoparcial : Form
    {
        ...
        private void pagoparcial_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT socios.id as numero_de_socio, socios.nombre,apellido,sexo,fecha_ingreso,ciudad,calle,numero,telefono,edad,tipo_s.nombre as tipo_pago FROM socios,tipo_s WHERE socios.tipo_p = tipo_s.id AND tipo_s.nombre = 'PAGO PARCIAL'";
